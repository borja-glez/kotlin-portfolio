...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ib_save.setOnClickListener {
            if (isWriteStorageAllowed()) {
                BitmapAsyncTask(getBitmapFrowView(fl_drawing_view_container)).execute()
            } else {
                requestStoragePermission()
            }
        }
    ...
    private fun requestStoragePermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(
            ...
            Toast.makeText(
                this, "Need permission to add a Background image", Toast.LENGTH_SHORT
            ).show()
        }
    ...
    private fun getBitmapFrowView(view: View): Bitmap {
        ...
        private suspend fun doInBackground(): String = withContext(Dispatchers.IO) {
            ...
            if (mBitmap != null) {
                try {
                    ...
                    val f =
                        File(
                            externalMediaDirs[0]!!.absoluteFile.toString() +
                                    File.separator +
